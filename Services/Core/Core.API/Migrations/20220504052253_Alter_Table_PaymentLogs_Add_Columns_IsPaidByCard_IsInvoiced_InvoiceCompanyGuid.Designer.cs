...
namespace Core.API.Migrations
{
    ...
    [Migration("20220504052253_Alter_Table_PaymentLogs_Add_Columns_IsPaidByCard_IsInvoiced_InvoiceCompanyGuid")]
    partial class Alter_Table_PaymentLogs_Add_Columns_IsPaidByCard_IsInvoiced_InvoiceCompanyGuid
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Common.Models.Core.Entities.NotificationUserMappings", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Core.API.Entities.ADTemplateSetLenderPlans", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("ADTemplateSetLenderPlans");
                });
            ...
            modelBuilder.Entity("Core.API.Entities.AppImages", b =>
                {
                    ...
                    b.Property<string>("BypassRequestedBy")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("Core.API.Entities.Applications", b =>
                {
                    ...
                    b.Property<DateTime?>("LastNotifiedTime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Core.API.Entities.B2BApiKeys", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<bool>("IsReadEnabled")
                        .HasColumnType("bit");

                    b.Property<bool>("IsWriteEnabled")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("B2BApiKeys");
                });

            modelBuilder.Entity("Core.API.Entities.B2BWebHooks", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("B2BWebHooks");
                });

            modelBuilder.Entity("Core.API.Entities.DVSChecks", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Core.API.Entities.IllionIntegrationDetails", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Core.API.Entities.PaymentLogs", b =>
                {
                    ...
                    b.Property<string>("InvoiceCompanyGuid")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Core.API.Entities.SP.Usp_B2B_GetInspections", b =>
                {
                    ...
                    b.Property<string>("BrokerSurName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("DocumentsAccepted")
                        .HasColumnType("int");

                    b.Property<int>("DocumentsPending")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsSellerActionRequired")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("UploadPercentage")
                        .HasColumnType("int");

                    b.ToTable("B2BInspectionsList", t => t.ExcludeFromMigrations());
                });

            modelBuilder.Entity("Core.API.Entities.SP.Usp_GetCompaniesDashboardDatas", b =>
                {
                    b.Property<int>("BrokersInvolved")
                        .HasColumnType("int");

                    b.Property<int>("CompaniesInvolved")
                        .HasColumnType("int");

                    b.Property<int>("InspectionsCount")
                        .HasColumnType("int");

                    b.Property<short>("InspectionsStatus")
                        .HasColumnType("smallint");

                    b.Property<string>("ProcessingTime")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SellerResponseTime")
                        .HasColumnType("nvarchar(max)");

                    b.ToTable("CompaniesDashboardDatas", t => t.ExcludeFromMigrations());
                });
